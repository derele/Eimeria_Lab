...
output:
  ...
  html_document:
    theme: cerulean
Included in Publication: Víctor Hugo Jarquín-Díaz, Alice Balard, Jenny Jost, Julia
  Kraft, Mert Naci Dikmen, Jana Kvičerová Emanuel Heitlinger, Detection and quantification
  of house mouse Eimeria at the species level – Challenges and solutions for the assessment
  of coccidia in wildlife, International Journal for Parasitology. Parasites and Wildlife,
  Volume 10, 2019, https://doi.org/10.1016/j.ijppaw.2019.07.00
---
...
Easy way out:
Add your results of the dna concentrations to an excel table and
calculate your results with these equation 
...
Infection intensity was estimated as the DCt between mouse and Eimeria amplification (CtMouse- CtEimeria). 

To correct for background noise a detection threshold was estimated at "DCt = -5" and only results above this value were considered infected
