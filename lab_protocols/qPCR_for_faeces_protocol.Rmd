...
* for every sample we have triplicates and a negative control, which contains all the reagents without DNA
* set up the plate and the run before you start on: https://apps.thermofisher.com/

![96 well layout ](96-Well_plate.png){height=300px width=500px}
...
Finally pipette 20 µL in each well for the reaction

#### Spreadsheet to calculate pcr reagents quantities

https://docs.google.com/spreadsheets/d/1xxjRkLPJWdI-ALCn_EX0hPdLYyjwd0anVGqt-Ck4kbM/edit?usp=sharing
...
Design Analysis new --> set up pkate --> comparative cd - SYBR
