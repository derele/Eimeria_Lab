...
#load csv files#
Exp007a_design <- read.csv("../../data/2_designTables/Exp007a_design.csv")
Exp007b_design <- read.csv("../../data/2_designTables/Exp007b_design.csv")
E7aF <- read.csv("../../data/3_recordingTables/Exp007/Exp007a/Exp_007a_feces.csv")
E7bF <- read.csv("../../data/3_recordingTables/Exp007/Exp007b/Exp_007b_feces.csv")
...
WLoss_007_E64 <- summarySE(Exp007_E64, measurevar = "Wchange",
