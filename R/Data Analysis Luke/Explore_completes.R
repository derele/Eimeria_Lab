...
genes$EXP <- as.character(genes$EXP)
genes$EXP[genes$EXP == "E7"] <- "lab"
genes$EXP[genes$EXP == "P3"] <- "lab"

immuno <- full_join(FACScombine, genes, all.x = T)
