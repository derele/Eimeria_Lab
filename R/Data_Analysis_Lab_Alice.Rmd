...
```{r setupExpe1, echo=FALSE, warning=FALSE, cache=TRUE}
...
## 1. Weight loss
```{r weightalong1, echo=FALSE, warning=FALSE, fig.width = 12, fig.height = 10, cache=TRUE}
...
```{r weightalongsum1, echo=FALSE, warning=FALSE, fig.width = 12, fig.height = 10, cache=TRUE}
...
```{r stats1, echo=FALSE, warning=FALSE, fig.width = 12, fig.height = 10, cache=TRUE}
...
max.loss_001$Mouse_strain <- factor(max.loss_001$Mouse_strain, 
                                    levels = c("F1 hybrids \n(WP)",
                                               "M.m.domesticus \n(WSB)",
                                               "M.m.musculus \n(PWD)"))

kruskal.test(relativeWeight ~ Mouse_strain, data = max.loss_001)
pairwise.wilcox.test(max.loss_001$relativeWeight, max.loss_001$Mouse_strain,
                 p.adjust.method = "BH")
```

## 2. Parasite shedding

```{r OPGalong1, echo=FALSE, warning=FALSE, fig.width = 12, fig.height = 10, cache=TRUE}
...
```{r OPGalongsum1, echo=FALSE, warning=FALSE, fig.width = 12, fig.height = 10, cache=TRUE}
...
```{r stats1opg, echo=FALSE, warning=FALSE, fig.width = 12, fig.height = 10, cache=TRUE}
...
sum.oocysts_001$Mouse_strain <- factor(sum.oocysts_001$Mouse_strain, 
                                    levels = c("F1 hybrids \n(WP)",
                                               "M.m.domesticus \n(WSB)",
                                               "M.m.musculus \n(PWD)"))

kruskal.test(sum.oo ~ Mouse_strain, data = sum.oocysts_001)
pairwise.wilcox.test(sum.oocysts_001$sum.oo, sum.oocysts_001$Mouse_strain,
                 p.adjust.method = "BH")
```

## 3. Comparison host/parasite proxy

```{r plotComp1, echo=FALSE, warning=FALSE, cache=TRUE, fig.width = 12, fig.height = 10, fig.cap="\\label{fig:plotComp1} Weight as a function of OPG"}
## Plot comparison weightloss vs OPG, all day counfounded
ggplot(ExpeDF_001Symptomatic, 
  ...
  scale_x_log10() +
  coord_cartesian(ylim =  c(80,110)) +
  ggtitle("Relative weight loss compared to dpi3, during the symptomatic phase, vs parasite outcome") +
  mytheme
```
...
```{r prepPass1, echo=FALSE, cache=TRUE}
...
```{r Pass001, echo=FALSE, warning=FALSE, fig.width = 12, fig.height = 10, cache=TRUE}
...
```{r setupExpe2, echo=FALSE, warning=FALSE, cache=TRUE}
...
## 1. Weight loss
```{r weightalong2, echo=FALSE, warning=FALSE, fig.width = 12, fig.height = 10, cache=TRUE}
...
```{r weightalongsum2, echo=FALSE, warning=FALSE, fig.width = 12, fig.height = 10, cache=TRUE}
...
```{r OPGalong2, echo=FALSE, warning=FALSE, fig.width = 12, fig.height = 10, cache=TRUE}
...
```{r OPGalongsum2, echo=FALSE, warning=FALSE, fig.width = 12, fig.height = 10, cache=TRUE}
...
```{r plotComp2, echo=FALSE, warning=FALSE, cache=TRUE, fig.width = 12, fig.height = 10, fig.cap="\\label{fig:plotComp1} Weight as a function of OPG"}
## Plot comparison weightloss vs OPG, all day counfounded
ggplot(ExpeDF_002, 
...
```{r setupExpe3, echo=FALSE, warning=FALSE, cache=TRUE}
...
# Keep only mice that survived 11 days
# survivors <- names(table(ExpeDF_003_4$EH_ID))[table(ExpeDF_003_4$EH_ID) %in% 12]
# ExpeDF_003_4 <- ExpeDF_003_4[ExpeDF_003_4$EH_ID %in% survivors,]
...
## 1. Weight loss
```{r weightalong3, echo=FALSE, warning=FALSE, fig.width = 12, fig.height = 10, cache=TRUE}
...
```{r weightalongsum3, echo=FALSE, warning=FALSE, fig.width = 12, fig.height = 10, cache=TRUE}
...
```{r stats3, echo=FALSE, warning=FALSE, fig.width = 12, fig.height = 10, cache=TRUE}
...
```{r OPGalong3, echo=FALSE, warning=FALSE, fig.width = 12, fig.height = 10, cache=TRUE}
...
```{r OPGalongsum3, echo=FALSE, warning=FALSE, fig.width = 12, fig.height = 10, cache=TRUE}
...
```{r stats3opg, echo=FALSE, warning=FALSE, fig.width = 12, fig.height = 10, cache=TRUE}
# Cumulative OPG along experiment
...
```{r setupExpe5, echo=FALSE, warning=FALSE, cache=TRUE}
...
### TO CORRECT!!
# Keep only mice that survived 11 days for E. falciformis, and 8 days for E. ferrisi
# survivors88 <- names(table(ExpeDF_005_E88$EH_ID))[table(ExpeDF_005_E88$EH_ID) %in% 12]
# ExpeDF_ExpeDF_005_E88 <- ExpeDF_005_E88[ExpeDF_005_E88$EH_ID %in% survivors88,]
# 
# survivors64 <- names(table(ExpeDF_005_E64$EH_ID))[table(ExpeDF_005_E64$EH_ID) %in% 9]
# ExpeDF_ExpeDF_005_E64 <- ExpeDF_005_E64[ExpeDF_005_E64$EH_ID %in% survivors64,]
...
```{r weightalong5_E64, echo=FALSE, warning=FALSE, fig.width = 12, fig.height = 10, cache=TRUE}
...
```{r weightalongsum5_E64, echo=FALSE, warning=FALSE, fig.width = 12, fig.height = 10, cache=TRUE}
...
```{r stats5_E64, echo=FALSE, warning=FALSE, fig.width = 12, fig.height = 10, cache=TRUE}
...
```{r weightalong5_E88, echo=FALSE, warning=FALSE, fig.width = 12, fig.height = 10, cache=TRUE}
...
```{r weightalongsum5_E88, echo=FALSE, warning=FALSE, fig.width = 12, fig.height = 10, cache=TRUE}
...
```{r stats5_E88, echo=FALSE, warning=FALSE, fig.width = 12, fig.height = 10, cache=TRUE}
...
```{r OPGalong5_64, echo=FALSE, warning=FALSE, fig.width = 12, fig.height = 10, cache=TRUE}
...
```{r OPGalongsum5_64, echo=FALSE, warning=FALSE, fig.width = 12, fig.height = 10, cache=TRUE}
...
```{r stats5_64opg, echo=FALSE, warning=FALSE, fig.width = 12, fig.height = 10, cache=TRUE}
# Cumulative OPG along experiment
...
```{r OPGalong5_88, echo=FALSE, warning=FALSE, fig.width = 12, fig.height = 10, cache=TRUE}
...
```{r OPGalongsum5_88, echo=FALSE, warning=FALSE, fig.width = 12, fig.height = 10, cache=TRUE}
...
```{r stats5_88opg, echo=FALSE, warning=FALSE, fig.width = 12, fig.height = 10, cache=TRUE}
# Cumulative OPG along experiment
