...
## 1. Weight loss
```{r weightalong2, echo=FALSE, warning=FALSE, fig.width = 12, fig.height = 5, fig.cap="\\label{fig:weightalong2} Weight along the infection experiment"}
plotWeightAlongInf(ExpeDF_002, ylim = c(88, 108))
```

```{r weightalongsum2, echo=FALSE, warning=FALSE, fig.width = 12, fig.height = 5, fig.cap="\\label{fig:weightalongsum2} Weight along the infection experiment, mean and 95% CI"}
