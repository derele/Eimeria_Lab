...
## 1. Weight loss
```{r weightalong, echo=FALSE, warning=FALSE, fig.width = 12, fig.height = 10, fig.cap="\\label{fig:weightalong} Weight along the infection experiment"}
plotWeightAlongInf(ExpeDF_001, ylim = c(80, 110))
```

```{r weightalongsum, echo=FALSE, warning=FALSE, fig.width = 12, fig.height = 10, fig.cap="\\label{fig:weightalongsum} Weight along the infection experiment, mean and 95% CI"}
...
```{r weightalong5, echo=FALSE, warning=FALSE, fig.width = 12, fig.height = 10, fig.cap="\\label{fig:weightalong4} Weight along the infection experiment"}
plotWeightAlongInf(ExpeDF_005, ylim = c(75, 120))
```
